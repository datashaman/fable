...
class PlaybookResource extends Resource
{
    ...
    {
        return Response::text(<<<'PLAYBOOK'
# Fable Domain Playbook

Read this playbook before using any other Fable capability. Fable separates the state of a fictional world from what characters believe and from how a story presents that world. Preserve those boundaries in every operation.
